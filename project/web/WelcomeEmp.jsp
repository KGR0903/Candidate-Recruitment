<%-- 
    Document   : WelcomeEmp
    Created on : 21 Jan, 2020, 11:36:58 AM
    Author     : Gowtham Raj
--%>
...
<html>
    ...
    <body style="padding:20px 300px 100px 200px;color:black;font-weight: bolder">
        <form method="post" action="EmpDetail.jsp" target="ContentFrame">
            <table>
                <tr class="autostyle2">
                    <td colspan="2"><div class="wel"><center>Fresher/Employee</center></div></td>
                    <td>
