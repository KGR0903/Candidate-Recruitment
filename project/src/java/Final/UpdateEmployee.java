...
public class UpdateEmployee extends HttpServlet {
    ...
    Connection con;
    Statement stmt;
    String Email,ContactNumber,CurrentCity,YearofExperience,SkillsSets;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String query = "update EmpDetails set ContactNumber='"+ContactNumber+"',CurrentCity='"+CurrentCity+"',YearofExperience='"+YearofExperience+"',SkillsSets='"+SkillsSets+"' where EmailID='"+Email+"'";
         stmt.execute(query);
